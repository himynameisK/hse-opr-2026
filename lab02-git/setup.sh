...
if [[ -e "$LAB" ]]; then
  ...
  echo "Или разверните в другой: make lab2 LAB2_DEST=/tmp/opr-lab02" >&2
  echo "Без make (Git Bash на Windows): bash lab02-git/setup.sh /tmp/opr-lab02" >&2
  exit 1
fi
