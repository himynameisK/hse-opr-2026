...
if [[ -e "$LAB" ]]; then
  ...
  echo "Или разверните в другой: make lab1 LAB1_DEST=/tmp/opr-lab01" >&2
  echo "Без make (Git Bash на Windows): bash lab01-git/setup.sh /tmp/opr-lab01" >&2
  exit 1
fi
